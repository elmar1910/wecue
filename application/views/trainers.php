...
<div class="wrapper">
    ...
    <div id="main">
        ...
        <div id="sidebar">
            ...
            <div id="sidemenu">
            	<ul>
		    <li><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/img/icons/sidemenu/laptop.png" width="16" height="16" alt="icon"/>Dashboard</a></li>
		    <li class="active"><a href="<?php echo base_url(); ?>trainers"><img src="<?php echo base_url(); ?>assets/img/icons/sidemenu/user.png" width="16" height="16" alt="icon"/>Trainers</a></li>
                </ul>
            </div>
            <!-- end sidemenu -->
        ...
        <div id="page">
                ...
                <div class="page-title">
                	<div class="in">
                    		<div class="titlebar">	<h2>TRAINERS</h2>	<p>This is a quick overview of some features</p></div>
